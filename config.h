...
ResourcePref resources[] = {
    ...
    {"shell", STRING, &shell},
    /* { "xfps",         INTAGER, &xfps }, */
    /* { "actionfps",    INTAGER, &actionfps }, */
    {"blinktimeout", INTAGER, &blinktimeout},
    {"bellvolume", INTAGER, &bellvolume},
    {"tabspaces", INTAGER, &tabspaces},
    {"cwscale", FLOAT, &cwscale},
    {"chscale", FLOAT, &chscale},
    {"alpha", FLOAT, &alphaUnfocused},
    {"alphafocus", FLOAT, &alpha},
};
